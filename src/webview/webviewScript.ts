/**
 * Returns the main interaction script injected into the webview.
 * Handles clicks, context menu, partial active-state updates and optional D&D.
 *
 * @param dragDropScript - Optional D&D script fragment to append (empty string to disable).
 */
export function getWebviewScript(dragDropScript: string): string {
  return `
