...
import { FileAction, ResolvedFileAction, BUILTIN_ACTIONS } from '../../constants/fileActions/index';

// Re-export for consumers that import from this module
export type { FileAction, ResolvedFileAction } from '../../constants/fileActions/index';
